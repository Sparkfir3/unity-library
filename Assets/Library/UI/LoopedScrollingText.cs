...
namespace Sparkfire.UI
{
    public class LoopedScrollingText : MonoBehaviour
    {
        ...
        [TitleGroup("Scroll Settings"), SerializeField]
        ...
        [TitleGroup("Text Settings"), SerializeField, TextArea(2, 4)]
        private string textToLoop;
        [SerializeField]
        private float textSpacing;

        [TitleGroup("Object References"), SerializeField]
        private GameObject firstTextObject;
        [SerializeField]
        ...
        private void Awake()
        {
            ...
            firstRectTransform.anchoredPosition = scrollLeft
                ? new Vector2(startOffScreen ? firstRectTransform.rect.width + 5f : _rectTransform.rect.width * -1f, 0f)
            ...
            for(int i = 1; i < textObjects.Count; i++) SetTextParent(textObjects[i], textObjects[i - 1]);
        }
